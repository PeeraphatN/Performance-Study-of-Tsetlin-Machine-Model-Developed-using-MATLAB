...
os.makedirs("result\\mnist_pure_python", exist_ok=True)

csv_path = os.path.join("result","mnist_pure_python","mnist_pure_python_result_log.csv")
...
log_dir = os.path.join("result", "mnist_pure_python")
