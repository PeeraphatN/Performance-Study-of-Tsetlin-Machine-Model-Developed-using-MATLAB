function MNIST(varargin)
    ...
    addParameter(p, 'clauses', 1000, @isnumeric);
    ...
    log_dir = fullfile("MATLAB", "result", "mnist");
    ...
    epoch_log_path = fullfile(log_dir, sprintf("mnist_epoch_log_%s.csv", timestamp));
    ...
    summary_path = fullfile(log_dir, "mnist_result_log.csv");
